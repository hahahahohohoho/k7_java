...
//		list3.removeAll(list2);
	...
	public static void main(String[] args) {
		try {
			...
			String[] sarray1 = s1.split("\\s*,\\s*|\\s+");// [,\\s]+\r\n은 쉼표나 공백이 하나 이상 나오고 이어서 캐리지 리턴과 개행 문자가 있는 패턴
			String[] sarray2 = s2.split("\\s*,\\s*|\\s+");//file에서 enter키는 \r\n으로 해야 분리됨
	...
	static void showData(String msg, String[] sarray) {
		System.out.print(msg + " : ");
		for(String i : sarray) {
			System.out.print(i + " ");
		}System.out.println();
	}
	static void showList(String msg, List<String> list3) {
		System.out.print(msg + " : ");
